...
class MonAnnotationView: MKAnnotationView {
    ...
    //on cree un controller pour la fonction detail
    
    var controller: Controller_Avec_Carte?
    
    init(controller: Controller_Avec_Carte, annotation: MKAnnotation, reuseIdentifier: String?) {
    ...
    @objc func detail() {
        ...
        //@objC: on ne peut pas ici activer un prepareforsegue.
        
        //Premiere solution: Il faut passer par un vc
        //controller?.toDetail(calanque: anno.calanque)
        
        //deuxieme solution: passer par le notification center
